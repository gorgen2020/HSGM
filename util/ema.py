...
class EMA(Optimizer):
    def __init__(self, opt, ema_decay):
        ...
        self._optimizer_state_dict_pre_hooks = {}  # Add this line to define the missing attribute

    def state_dict(self):
        # Here, we need to return both EMA's state and the underlying optimizer's state
        state_dict = {
            'ema_decay': self.ema_decay,
            'optimizer_state_dict': self.optimizer.state_dict()  # Save the underlying optimizer's state
        }
        return state_dict
