...
from main_model import CSDI_MIMIC
from dataset_MIMIC import get_dataloader
...
foldername = "./save/MIMIC_fold" + str(args.nfold) + "_" + current_time + "/"
...
model = CSDI_MIMIC(config, args.device).to(args.device)
